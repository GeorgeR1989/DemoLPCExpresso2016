...
{
	STATIC uint8_t red = 50;          /* SET initial intensity RED   */
	STATIC uint8_t green = 100;       /* SET initial intensity GREEN   */
	STATIC uint8_t blue = 150;        /* SET initial intensity BLUE   */
